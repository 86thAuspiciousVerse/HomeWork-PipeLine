...
Define plugin-level behavior for scenario-neutral P0-P4 artifact contracts, resource closure, verifiability degradation, and contract-derived planning. Runtime artifact schemas remain owned by the plugin implementation, prompts, and tests.
